    ...
    if (obj.data) {
        obj.data.forEach(item => {
            if (item.extraDataArr) {
                const adKeysToModify = new Set(["Ad.CHANGE_AFTER_SHOW","Ad.ADLOAD_POS_ID","Ad.KS_APP_ID","Ad.DOWNLOAD_POPUP","Ad.PRELOAD","Ad.PRELOAD_AFTER_USE","Ad.PRELOAD_THRESHOLD","Ad.PRELOAD_THRESHOLD_IOS","Ad.GDT_APP_ID","Ad.TO_APP_ID","Ad.TO_APP_KEY","Ad.TT_APP_ID","Ad.BZ_APP_ID","Ad.SPLASH_DOWNLOAD_POPUP","Ad.SPLASH_RETRY_PERIOD","Ad.CLICK_BUTTON_AREA","Ad.GROWTH_BACK_PRESS"]);
